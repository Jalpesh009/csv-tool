...
trait UserAttribute
{
    ...
    {
        return '<a href="'.route('admin.auth.user.show', $this).'" data-toggle="tooltip" data-placement="top" title="'.__('buttons.general.crud.view').'" class="cbtn cprimary btn-icon text-white load_game_data p-2"><i class="mdi mdi-eye menu-icon"></i></a>';
    }
    ...
    {
        return '<a href="'.route('admin.auth.user.edit', $this).'" data-toggle="tooltip" data-placement="top" title="'.__('buttons.general.crud.edit').'" class="cbtn csuccess btn-icon p-2 edit_modal"><i class="text-white mdi mdi-pencil menu-icon"></i></a>';
    }
    ...
    {
        return '<a href="'.route('admin.auth.user.delete-permanently', $this).'" name="confirm_item" class="cbtn cdanger btn-icon text-white p-2"><i class="mdi mdi-delete" data-toggle="tooltip" data-placement="top" title="'.__('buttons.backend.access.users.delete_permanently').'"></i></a> ';
    }
    ...
    {
        return '<a href="'.route('admin.auth.user.restore', $this).'" name="confirm_item" class="cbtn cprimary btn-icon text-white p-2"><i class="mdi mdi-sync" data-toggle="tooltip" data-placement="top" title="'.__('buttons.backend.access.users.restore_user').'"></i></a> ';
    }
    ...
    public function getActionButtonsAttribute()
    {
    	...
    	<div class="btn-group" role="group" aria-label="'.__('labels.backend.access.users.user_actions').'">
		  ...
		  <div class="btn-group btn-group-sm" role="group">
			<button id="userActions" type="button" class="cbtn cwarning btn-icon csv_download text-white wide p-2 dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
