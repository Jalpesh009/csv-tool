        ...
        <div class="card-body">     
            <div class="row"> 
                ...
                <?php  foreach($game_fields as $game_field) {
                    if($game_field['master_fields']['master_field_slug'] == 'game_logo') { 
                ...
                <div class="col-md-9 col-lg-9 col-xl-10"> 
                    ...
                    if($game_field['master_fields']['master_field_slug'] == 'game_name') { ?>
                            ...
                            <div class="title-action d-flex justify-content-between">
                                <h2 class="game-title mt-3"><?php echo $game_field['field_value']; ?></h2>.
                    ...
                    if($game_field['master_fields']['master_field_slug'] == 'game_description'){ ?>
                            <p class="game-discription"> <?php echo $game_field['field_value']; ?> </p>
                    <?php }  } ?>

                    <?php foreach($game_fields as $game_field) {
                    if($game_field['master_fields']['master_field_slug'] == 'price') { ?>
                        <button type="button" class="gredient-btn mt-3"> 
                            <?php 
                            if (is_numeric($game_field['field_value'])){
                                echo '€ '. number_format($game_field['field_value'],2) ;  
                            }else{
                                echo $game_field['field_value'];
                            } ?>
                        </button>
                    <?php }  } ?> 
                </div>  
                    ...
                    <div class="tab-content tab-content-custom-pill pr-0" id="pills-tabContent-custom">
                        <div class="tab-pane fade active show" id="game-overview" role="tabpanel" aria-labelledby="pills-overview-tab-custom">
                            ...
                            <div class="col-sm-12 mb-4 game-screenshots1">
                                <h3 class="content-title mb-3">Images</h3> 
                                <?php foreach($game_fields as $game_field) { 
                        ...
                        <div class="tab-pane fade " id="game-info" role="tabpanel" aria-labelledby="pills-game-info-tab-custom">
                            <div class="col-sm-12">
                                ...
                                <?php  foreach($game_fields as $game_field) { 
                                    if($game_field['master_fields']['master_field_slug'] != 'game_logo' && $game_field['master_fields']['master_field_slug'] != 'game_name' && $game_field['master_fields']['master_field_slug'] != 'game_description' && $game_field['master_fields']['master_field_slug'] != 'price' && $game_field['master_fields']['master_field_type'] != 'gallery') {?>
                                        <li class="list list-group-item">
                                            <label  class="col-md-4 font-weight-bold m-0"><?php echo $game_field['master_fields']['master_field_name']; ?></label >
                                            <span class="col-md-8"><?php echo $game_field['field_value']; ?></span>
                                        </li> 
                                <?php }  } ?>
                                </ul>
                            </div> 
