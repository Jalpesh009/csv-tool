                                        ...
                                        if($game_field['master_fields']['master_field_type'] == 'image'){ ?>
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <div class="form-group row"> 
                                                    <div class="col-md-9">
                                                    <label for="store_logo"> {{ $game_field['master_fields']['master_field_name'] }} <?php echo $star; ?> </label>   
                                                        <input type="file" name="photos_<?php echo $game_field['id']; ?>" id="store_logo" class="file-upload-default" {{ $req }}> 
                                                    ...
                                                    <div class="col-md-3 store-logo-upload-edit"> 
                                                        ...
                                                        <?php } else { ?>
                                                        <a href="javascript:void(0);" class="delete_game_image" ><div class="badge badge-pill badge-warning "><i class="mdi mdi-close"></i></div> </a> 
                                                            <img src="<?php echo  url('/public/img/backend/placeholder/150.png'); ?>" class="game_logo_img">
                                                        <?php }?>
                                                    </div><!--col-md-6--> 
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group row"> 
                                                    <div class="col-md-12">
                                                        ...
                                                        <input class="form-control" type="text" name="input[game][{{ $game_field['id']}}]" value="{{  $game_field['field_value']  }}" id="fieldid_{{ $game_field['id'] }}"  {{ $req }}>
                                                    </div><!--col-md-12-->
                                                </div><!--form-group row-->
                                            </div><!--col-md-6--> 
    									<?php } if($game_field['master_fields']['master_field_type'] == 'gallery') { ?>
