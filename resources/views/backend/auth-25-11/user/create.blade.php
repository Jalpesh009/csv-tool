            ...
            <div class="card-body">
                ...
                <div class="row mt-4 mb-4">
                    <div class="col">
                        ...
                        @endif
                        {{ html()->hidden('avatar_type')->value('storage') }}
                        {{ html()->hidden('avatar_location')->value( "avatars/default-game.jpg") }}
                        <div class="form-group row">
