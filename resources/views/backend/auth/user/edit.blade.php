        ...
        <div class="card-body">
            ...
            <div class="row mt-4 mb-4">
                <div class="col">
                    ...
                    <div class="form-group row">
                        {{ html()->label(__('validation.attributes.frontend.avatar'))->class('col-md-2 form-control-label')->for('avatar') }}
                        <div class="col-md-10 hidden" id="avatar_location">
                                {{ html()->file('avatar_location')->class('form-control') }}
                            </div><!--form-group-->

                    </div><!--form-group-->
                    <input type="hidden" name="avatar_type" value="storage"/> 
                    <input type="hidden" name="roles[]" value="{{  $user->roles->toArray()[0]['name']  }}" checked/>
                    <?php /* @if ($logged_in_user->isAdmin()   ) */ ?>
                    @if ($logged_in_user->can('view-user-access') || $logged_in_user->isAdmin()  )
                    <div class="form-group row">
