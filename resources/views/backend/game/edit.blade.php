                            ...
                            if($game_fields){
                                foreach($game_fields as $game_field) {
                                    ...
                                    if($game_field['master_fields']['master_field_type'] == 'image'){
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="form-group row edit_image">
                                                ...
                                                <input type="hidden" class="edit_image_name single_image" name="edit_image_<?php echo $game_field['id']; ?>" value="<?php echo $img2; ?>"> 
                                                ...
                                                <div class="col-md-4 col-lg-3 store-logo-upload-edit">
                                                    ...
                                                    <?php if( $game_field['field_value'] != NULL ){ ?>
                                                    ...
                                                    <?php } else { ?>
                                                        <a href="javascript:void(0);" class="delete_game_image d-none" ><div class="badge badge-pill badge-warning "><i class="mdi mdi-close"></i></div> 
                                                        </a>
                                                        <img src="<?php echo  url('/public/uploads/default-game.jpg'); ?>" class="game_logo_img d-none" alt="game_image">
                                                    <?php }?>
                                                </div><!--col-md-6-->
                                    ...
                                    <?php } else if($game_field['master_fields']['master_field_type'] != 'gallery'){
                                            ...
                                            $inputtype = 'text';
                                            $inputclass = '';
                                            $inputid = 'fieldid_'. $game_field['id'];
                                            $input_datecls = '';
                                            if($game_field['master_fields']['master_field_type'] == 'readonly' ){
                                                $inputtype = 'hidden';
                                                $inputclass = 'd-none';
                                            }
                                            if($game_field['master_fields']['master_field_type'] == 'date' ){ 
                                                $inputid = 'datepicker_'. $game_field['id'];
                                                $input_datecls = 'datepicker';
                                            }
                                        ...
                                        <?php } elseif($game_field['master_fields']['master_field_isunic'] == 'yes'){ ?> 
                                            <input class="form-control" type="hidden" name="input[game][{{ $game_field['id']}}]" value="{{  $game_field['field_value']  }}" id="fieldid_{{ $game_field['id'] }}" >
                                            ...
                                            <div class="col-md-6 {{ $inputclass }}">
                                                <div class="form-group row">
                                                    <div class="col-md-12">
                                                        ...
                                                        <label for="edit_field_name"> {{ $game_field['master_fields']['master_field_name'] }} <?php echo $star; ?> </label>
                                                        <input class="form-control {{ $input_datecls }}" type="{{ $inputtype }}" name="input[game][{{ $game_field['id']}}]" value="{{  $game_field['field_value']  }}" id="{{ $inputid }}"  {{ $req }}>
                                                    </div><!--col-md-12-->
                                                </div><!--form-group row-->
                                            </div><!--col-md-6-->
                                        <?php } ?>
                                ...
                                foreach($game_fields as $game_field) {
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        if(json_decode($game_field['field_value'] )){
                                            // $old_imgs = json_decode($game_field['field_value']);
                                            ...
                                            <div class="col-lg-3 col-md-6 col-xs-12 store-logo-upload-edit gallery_img_<?php echo $ki+1?>">
                                                <?php echo '<input type="hidden" name="multi_images_imgs[]" value="'. $img . '">'; ?>
                                                ...
                                                <img src="<?php echo  rtrim(ltrim($img)); ?>" class="game_gallery_img">
                                                <input class="form-control" type="hidden" name="input[game][{{ $game_field['id']}}][]" value="<?php echo  rtrim(ltrim($img)); ?>" id="fieldid_{{ $ki }}"  {{ $req }}>
                                            </div>
                                            <?php
                                            }
                                        }?>
