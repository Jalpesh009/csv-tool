...
$("#store_logo, #old_store_logo").change(function() {
    // alert("ASdsad");
    readURL(this);
});


$('.store_logo').on('change', function(event) {
    var $input = $(this);
    ...
    if (this.files && this.files[0]) {
        var reader = new FileReader();
        reader.onload = function(e) { 
            $input.parent().siblings().find(".game_logo_img").show();
            $input.parents('.edit_image').find(".edit_image_name").val(fileName);
            // $input.parents('.edit_image').find(".edit_image_name1").val(fileName);
            $input.parent().siblings().find(".delete_game_image").show();
            $input.parent().siblings().find(".game_logo_img").attr('src', e.target.result ); 
            $input.parent().siblings().find(".game_logo_img").removeAttr('alt');
            $input.parent().siblings().find(".game_logo_img").removeClass('d-none'); 
            $input.parent().siblings().find(".delete_game_image").removeClass('d-none'); 
            $input.parent().siblings().find(".delete_game_image").show(); 
        }
...
$(".delete_game_image").click(function() {
    // $(this).siblings(".game_logo_img").attr('src', ''); 
    $(this).siblings(".game_logo_img").hide();
    $(this).parents(".edit_image").find(".edit_image_name").val('');
    // $(this).parents(".edit_image").find(".edit_image_name").val('de');
    $(this).parents(".edit_image").find(".file-upload-info").val('');
    $(this).hide();
